...
namespace Tests\Feature\Http\Controllers\Api\v1\Products;
...
class IndexControllerTest extends TestCase
{
    ...
    public function test_returns_v1_response_header_on_first_call(): void
    {
        $user = User::factory()->create();
        Sanctum::actingAs($user);
    ...
    public function test_returns_v1_response_header_after_call_to_v2_is_cached(): void
    {
        $user = User::factory()->create();
        Sanctum::actingAs($user);
    ...
    public function test_categories_is_not_required_for_api_v1(): void
    {
        $user = User::factory()->create();
        Sanctum::actingAs($user);
