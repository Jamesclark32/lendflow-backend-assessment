...
return [
    ...
    /*
     * This setting determines if an http header named with the cache time
     ...
     */
    'cache_time_header_name' => env('RESPONSE_CACHE_HEADER_NAME', 'x-cached-at'),

    /*
     * This setting determines if an http header named with the cache age
     * should be added to a cached response. This can be handy when
     * debugging.
     ...
     * the age of cache
     */
    'cache_age_header_name' => env('RESPONSE_CACHE_AGE_HEADER_NAME', 'x-cached-age'),
